...
<body>
	...
	<form action="workbench/transaction/save.do" class="form-horizontal" method="post" id="tranForm" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="8868713f92714e0f8d0da3882eaa8b69">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="b8682ff6f6734310a7551d540d7a39d1">
			</div>
		</div>
